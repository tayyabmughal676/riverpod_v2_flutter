...
class AppSizes {
  ...
  late double medium17FontSize;
  late double medium16FontSize;
  ...
  void initializeSize(context) {
    ...
    medium17FontSize = 17.0 * fontRatio;
    medium16FontSize = 16.0 * fontRatio;
    ...
    jumbo35FontSize = 35.0 * fontRatio;
